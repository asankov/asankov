...
### Intro to Containers at Vocational High School for Audio, Video, and Telecommunications "A.S.Popov“
...
- [Notes](https://github.com/asankov/cloud-native-security)
- [Slides](https://github.com/asankov/cloud-native-security/blob/main/cloud-native-security.pdf)
- [YouTube recording](https://youtu.be/VMFFsfeNpKk)

### BSides Sofia 2023

**Topic:** Workshop: How to automate Application Security the DevSecOps way (with [Svetlomir Balevski](https://github.com/SvetlomirBalevski/))
...
- [Blog Post about the Session](https://blogs.vmware.com/explore/2022/10/27/day-0-the-security-mindset-changing-the-way-you-think-about-enterprise-security/)
...
- [Notes](https://github.com/asankov/securing-kubernetes-with-open-policy-agent/tree/main)
...
- [YouTube recording](https://www.youtube.com/live/DcOYB4cUM9U?feature=share&t=12186)
...
**Topic:** Workshop: Go 101 (with [Boris Stoyanov](https://github.com/borisbsv/))
...
- [Notes](https://github.com/asankov/securing-kubernetes-with-open-policy-agent/tree/main)
- [Slides](https://github.com/asankov/securing-kubernetes-with-open-policy-agent/blob/main/2022/kubehuddle-edinburgh/presentation.pdf)
- [YouTube recording (in Bulgarian)](https://www.youtube.com/watch?v=JewdgJASVxI)
...
- [YouTube recording](https://www.youtube.com/watch?v=yim8NnYjODY)
...
- [YouTube recording](https://www.youtube.com/watch?v=xyeXx2qtfLI)
...
**Date:** October 2019
**Location:** Sofia, Bulgaria 🇧🇬
**Topic:** Learn Python & Selenium the fast way (with [Alexandar Todorov](https://github.com/atodorov/))
